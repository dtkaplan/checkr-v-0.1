...
To illustrate, let's construct by hand the `USER_CODE` and `SOLUTION_CODE` contents that get produced from the question chunks in a `tutor` document.
```{r}
