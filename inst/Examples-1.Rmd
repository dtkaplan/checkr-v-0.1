...
test_3 <- assigns_to('Id', "give the result the name `Id`.")
...
test_2 <- assigns_to('Letter', "give the result the name `Letter`.")
...
test_1 <- assigns_to("df", "The data frame should be called 'df'")
test_2 <- check_value(
