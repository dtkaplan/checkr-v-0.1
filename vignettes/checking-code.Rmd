...
>    * do I want to restructure all the find_() functions so that they can be used in either "define a test" mode or "part of a pipeline" mode? See was_mistake() for how to do this.
