...
test_A <- fun_test("2 ^ NULL", "you've reversed the length and the square function", mistake = TRUE)
test_B <- fun_test("2 ^ 3", "you've reversed the length and the square function", mistake = TRUE)
